...
//个性化弹幕框		
$(".coolplayer-comment-setting-color input").on("click", function() {
	var textcolor = $(this).attr("value");
	setTimeout(function() {
		$('.cool-coolplayer-comment-input').css({
			"color": textcolor
		});
	}, 100);
});
$(".coolplayer-comment-setting-type input").on("click", function() {
	var texttype = $(this).attr("value");
	setTimeout(function() {
		$('.cool-coolplayer-comment-input').attr("dmtype", texttype);
	}, 100);
});
$("#dmset").on("click", function() {
	$(".coolplayer-comment-icon").trigger("click");
	$(".coolplayer-comment-setting-box").toggleClass("coolplayer-comment-setting-open")
	$("#coolplayer").toggleClass("coolplayer-hide-controller")
});
...
function week() {
	...
	barh.src = "//b-api.hcool.cc/b/my.js";
...
$(".cool-coolplayer-send-icon").on("click", function() {
	var inputtext = document.getElementById("dmtext");
	var sendtexts = inputtext.value;
	var sendtype = $('.cool-coolplayer-comment-input').attr("dmtype");
	var sendcolor = $('.coolplayer-comment-input').css("color");
	...
	$(".cool-coolplayer-comment-input").val("");
})
...
window.onload = function() {
	...
	$(".coolplayer-watching-number").text(usernum);
