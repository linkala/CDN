...
var fed = (_fed = {}, _defineProperty(_fed, 'global', (_ref2 = {}, _defineProperty(_ref2, 'init', function() {
...
}), _defineProperty(_ref2, 'cgdytv', 'www.cgdytv.com'), _defineProperty(_ref2, ''), _defineProperty(_ref2, 'tips', function(e) {
    alert(e)
    ...
    setTimeout(function() {
        var a = '<p class="fed-text-center fed-text-black fed-show" style="display: block!important;position: relative!important;float: none!important;color: #333!important;">本站主题由&nbsp;<a style="display: inline-block!important;position: relative!important;float: none!important;color: #333!important;" href="http://www.cgdytv.com">晨光影视</a>&nbsp;提供</p>';
    ...
    $(e)['click'](function() {
        $(e)['removeClass']('fed-text-bold fed-text-green1'), $(this)['addClass']('fed-text-bold fed-text-green1'), $(u)['removeClass']('fed-show')['hide'](), $(u)['eq']($(this)['index']())['addClass']('fed-show')
    })
...
}), _defineProperty(_ref5, "assn",function(a){$(document).on("keyup",a,function(a){a=window.event?a.keyCode:a.which;var b=$(this).val();b?fed.search.list(b,a):($(".fed-pops-key").hide(),$(".fed-pops-box").show())})}),_defineProperty(_ref5,"tracks",function(){fed.search.init();fed.navbar.init();fed.player.init();fed.myuser.init();fed.history.init();fed.message.init();fed.global.finish()}),_defineProperty(_ref5,"list",function(a,b){$.getJSON(vfed.tpl+"asset/fed/create.php?id=key&name="+encodeURIComponent(a),function(c){if(0<c.length){var d='<ul class="fed-pops-list fed-back-whits">';for(f in c){var e=c[f].type_name,g;for(g in c[f].vod_actor.split(","))-1!=c[f].vod_actor.split(",")[g].indexOf(a)&&(e=c[f].vod_actor.split(_b[100])[g]);d+='<li class="fed-pops-item fed-part-rows fed-line-bottom"><a class="fed-part-eone" href="'+fed.search.jump(c[f].vod_name,"vod")+'"><span class="fed-name fed-part-eone fed-col-xs9">'+c[f].vod_name.replace(a,'<span class="fed-text-green">'+a+"</span>")+'</span><span class="fed-part-eone fed-text-muted fed-text-right fed-col-xs3">'+e.replace(a,'<span class="fed-text-green">'+a+"</span>")+"</span></a></li>"}d+="</ul>"}var f=$(".fed-pops-back").prevAll().length;40==b?$(".fed-pops-item").hasClass("fed-pops-back")?f==$(".fed-pops-item").length-1?($(".fed-navs-input").val($(".fed-pops-item").eq(0).find(".fed-name").text()),$(".fed-pops-item").removeClass("fed-pops-back").eq(0).addClass("fed-pops-back")):($(".fed-navs-input").val($(".fed-pops-item").eq(f+1).find(".fed-name").text()),$(".fed-pops-item").removeClass("fed-pops-back").eq(f+1).addClass("fed-pops-back")):($(".fed-navs-input").val($(".fed-pops-item").eq(0).find(".fed-name").text()),$(".fed-pops-item").removeClass("fed-pops-back").eq(0).addClass("fed-pops-back")):38==b?0==f?($(".fed-navs-input").val($(".fed-pops-item").eq($(".fed-pops-item").length-1).find(".fed-name").text()),$(".fed-pops-item").removeClass("fed-pops-back").eq($(".fed-pops-item").length-1).addClass("fed-pops-back")):($(".fed-navs-input").val($(".fed-pops-item").eq(f-1).find(".fed-name").text()),$(".fed-pops-item").removeClass("fed-pops-back").eq(f-1).addClass("fed-pops-back")):0<c.length?($(".fed-pops-box").hide(),$(".fed-pops-key").show().html(d)):$.getJSON(vfed.path+"/index.php/ajax/suggest.html?mid=2&wd="+encodeURIComponent(a),function(b){var c='<ul class="fed-pops-list fed-back-whits">',d;for(d in b.list)c+='<li class="fed-pops-item fed-part-rows fed-line-bottom"><a class="fed-part-eone" href="'+$(".fed-navs-form").attr("data-art")+"?wd="+b.list[d].name+'"><span class="fed-name fed-part-eone fed-col-xs9">'+b.list[d].name.replace(a,'<span class="fed-text-green">'+a+"</span>")+"</span></a></li>";void 0==b.list[0]&&(c+='<li class="fed-pops-item fed-part-rows fed-line-bottom fed-margin-bottom"><a class="fed-part-eone" href="'+fed.search.jump(a,"art")+'"><span class="fed-name fed-part-eone fed-col-xs9">'+a+'</span><span class="fed-part-eone fed-text-muted fed-text-right fed-col-xs3">\u67e5\u770b\u66f4\u591a</span></a></li>');c+="</ul>";void 0!=b.list[0]?(fed.search.submit(".fed-navs-submit","art"),$(".fed-pops-box").hide()):$(".fed-pops-box").show();$(".fed-pops-key").show().html(c)})})}),_ref5)), _defineProperty(_fed, 'record', (_ref6 = {}, _defineProperty(_ref6, 'init', function() {
